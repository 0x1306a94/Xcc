...
/// A enhanced JSON decoder.
fileprivate struct _JSONDecoder: Decoder, SingleValueDecodingContainer {
...
fileprivate struct _JSONKeyedDecodingContainer<K>: KeyedDecodingContainerProtocol where K : CodingKey {
    typealias Key = K
...
fileprivate struct _JSONDecoderDetector: Decodable {
...
/// Map to oc object.
fileprivate class _JSONDecoderConverter: NSObject {
...
fileprivate struct _JSONDecoderOptioins {
    ...
    func isNull<K>(_ container: KeyedDecodingContainer<K>, forKey key: K) -> Bool where K : CodingKey {
