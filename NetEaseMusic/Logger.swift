...
internal class Logger {
    ...
    #if DEBUG
    internal static var appender: [Appender] = [
...
/// Writeer
private var handler = NSGetUncaughtExceptionHandler()
private var handlers = [Int32: (Int32) -> Void]()
private func resuable(label: String, qos: DispatchQoS = .default) -> DispatchQueue {
    // Lock the funcation.
...
// Forward Declaration.
@_silgen_name("backtrace") private func backtrace(_ array: UnsafeMutableBufferPointer<UnsafeRawPointer>, _ size: Int) -> Int
@_silgen_name("backtrace_symbols") private func backtrace_symbols(_ array: UnsafeMutableBufferPointer<UnsafeRawPointer>, _ size: Int) -> UnsafeBufferPointer<UnsafePointer<Int8>>?
